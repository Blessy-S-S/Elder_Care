...
if(isset($_POST['save_data-btn']))
{
    ...
    $quer = "INSERT INTO checkup (user_id,user_name,bp,sugar,chol,review,pres,cons) VALUES ('$nid','$n_name','$bp','$sugar','$chol','$review','$pres','$cons')";
    $query_run = mysqli_query($con, $quer);

    if($query_run)
    {
        redirect("index.php","Successfully inserted");
       
    }
    else
    {
        redirect("checkup.php","insertion failed"); 
    }
