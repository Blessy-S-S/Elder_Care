...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addModal">Add Staff</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="code.php" method="POST">
        <div class="modal-body">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            <button type="submit" name="add_admin" class="btn btn-primary">Add Staff</button>
        </div>
      </form>
    </div>
  </div>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="px-3 pt-3">
                    <h4 class="heading">Manage Staffs
                        <a href="#" data-bs-toggle="modal" data-bs-target="#addModal" class="btn btn-primary float-end">Add staff </a>
                    </h4>
                    <hr>
                </div>
                <div class="card-body">
                                ...
                                if(mysqli_num_rows($all_admin_run) > 0):
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <form action="code.php" method="POST">
                                                <?php if($row['status'] == '0') :?>                                                        
                                                    <button type="submit" value="<?=$row['id'];?>" <?= $row['super_admin'] == '1' ? 'disabled':'';?> class="btn btn-danger btn-sm" name="ban_admin">Restrict</button>
                                                <?php  else: ?>
                                                    <button type="submit" value="<?=$row['id'];?>" class="btn btn-success btn-sm" name="unban_admin">Active</button>
                                                <?php  endif; ?>
                                            </form>
                                        </td>
                                    </tr>
