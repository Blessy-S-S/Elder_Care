                    ...
                    <?php
                        if(isset($_SESSION['adminlogin']))
                        {
                            ...
                            if(mysqli_num_rows($all_bookings_query_run) > 0)
                            {
                                ...
                                $new_bookings_query = "SELECT b.id as omid, b.checkin,b.checkout,u.id,b.price, b.created_at, r.id, r.room_name, u.id, u.fname, u.lname, u.finame, u.laname FROM bookings b, rooms r, users u WHERE b.room_id= r.id AND u.id=b.user_id AND b.checkout >= '$today' ";
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    foreach($new_bookings_query_run as $newroom)
                                                    {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= $newroom['finame'].' '.$newroom['laname']; ?></td>
                                                            ...
                                                            <td><?php if(date("d-m-Y", strtotime($newroom['checkout']))<(date("Y/m/d"))) 
                                                            {
                                                                echo"<span class='badge badge-secondary bg-gradient-secondary px-3 rounded-pill'>Vecated</span>";
                                                            }
                                                            else{
                                                                echo"<span class='badge badge-success bg-gradient-success px-3 rounded-pill'>Already In</span>";
                                                            }
                                                                ?> </td>
                                                            <td> <a href="bill.php?id=<?= $newroom['id']; ?>" class="btn btn-primary btn-sm">View</a>  </td>
                                                        </tr>
                                        ...
                                        <div class="col-md-12 py-3 text-center">
                                            <div class="card shadow-sm">
                                                <div class="card-body py-5">
                                                    <h2 class="heading">No Admissions</h2>
                                                </div>
                                            </div>
                                        </div>
                                    <?php
