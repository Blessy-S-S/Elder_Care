        ...
        <ul class="navbar-nav ms-auto">
          ...
          <?php if(isset($_SESSION['login'])): ?>
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <li><a class="dropdown-item" href="checkup_data.php">Weekly Checkup</a></li>
              <li><a class="dropdown-item" href="medicine.php">Upload Medicines</a></li>
          ...
          <?php else: ?>
            ...
            <li class="nav-item">
              <a class="nav-link <?= $page == "register.php"?'active':''; ?>" href="register.php">APPLICATION FORM</a>
            </li>
          <?php endif; ?>
