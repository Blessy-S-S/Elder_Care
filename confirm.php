...
<section class="section">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="main-heading">Book Your stay</h4>
                                    ...
                                    <!-- Payment Modal -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                    ...
                                                    <h6 class="form-control bg-white"> Joining Date: <?= date('d-m-Y', strtotime($checkin)) ?></h6>
                                                    <h6 class="form-control bg-white"> Date of leaving: <?= date('d-m-Y', strtotime($checkout)) ?></h6>
                                                    <div class="text-end">
