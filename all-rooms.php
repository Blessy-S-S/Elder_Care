                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                   <!-- <label class="card-label">Check Availability by date</label>-->
                                    <button type="submit" class="btn btn-primary w-100">Available Rooms</button>
                                </div>
                            </div>
                        </form>
                    </div>
